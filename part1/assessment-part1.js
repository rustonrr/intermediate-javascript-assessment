...
String.prototype.grammarPolice = function() {
  var allLowerCase = this.toLowerCase();
  var strSplit = allLowerCase.split(" ");
  
  for (index = 0; index < strSplit.length; index = index + 1) {
    strSplit[index] = strSplit[index].charAt(0).toUpperCase() + strSplit[index].slice(1);
  }
